...
public class CustomToggleButton extends View {
    ...
    private CustomToggleButton(Context context) {
        super(context);
    }
    ...
    public void setup(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.CustomToggleButton);
        offBorderColor = typedArray.getColor(R.styleable.CustomToggleButton_offBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.CustomToggleButton_onColor, onColor);
        spotColor = typedArray.getColor(R.styleable.CustomToggleButton_spotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.CustomToggleButton_offColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.CustomToggleButton_toggleBorderWidth, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.CustomToggleButton_animate, defaultAnimate);
        isDefaultOn = typedArray.getBoolean(R.styleable.CustomToggleButton_isDefaultOn, isDefaultOn);
        typedArray.recycle();
