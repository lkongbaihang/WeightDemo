package com.yimishiji.widget.switchbutton;
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            ...
            backHeight = ta.getDimension(R.styleable.SwitchButton_kswBackHeight, thumbRadius * 2);
            backWidth = ta.getDimension(R.styleable.SwitchButton_kswBackWidth, backHeight * 3);
