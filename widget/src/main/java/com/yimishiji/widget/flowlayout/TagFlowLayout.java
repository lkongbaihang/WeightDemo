package com.yimishiji.widget.flowlayout;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    public void resetSelectState() {
        ...
        if (!mSelectedView.isEmpty()) {
            for (int pos : mSelectedView) {
                TagView tagView = (TagView) getChildAt(pos);
                assert tagView != null;
                tagView.setChecked(false);
            }
            mSelectedView.clear();
            if (mOnSelectListener != null) {
                mOnSelectListener.onSelected(null);
            }
        }
    }
    ...
    private void changeAdapter() {
        Log.d("tag_flow_layout", "changeAdapter");
        removeAllViews();
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            if (!TextUtils.isEmpty(mSelectPos)) {
                ...
                Set<Integer> restorePos = new HashSet<>();
                for (String pos : split) {
                    int index = Integer.parseInt(pos);
                    restorePos.add(index);
                }
                if (restorePos.equals(mSelectedView)) {
                    for (Integer index : mSelectedView) {
