...
public class SeekBarPressure extends View {
    ...
    public SeekBarPressure(Context context, AttributeSet attrs, int defStyle) {
        ...
        notScrollBarBg = getResources().getDrawable(R.drawable.bg_cloudy_peach_track);
        hasScrollBarBg = getResources().getDrawable(R.drawable.bg_dark_peach_track);
        mThumbLow = getResources().getDrawable(R.drawable.ic_filter_circle);
        mThumbHigh = getResources().getDrawable(R.drawable.ic_filter_circle);
...
//        mThumbHigh = getResources().getDrawable(R.drawable.seekbarpressure_thumb, null);
        ...
        //设置滑动块直径
        mThumbWidth = (int) (a.getDimension(R.styleable.SeekBarPressure_thumb_radius, 30) * 2);
        //设置滑动条高度
        mScollBarHeight = (int) a.getDimension(R.styleable.SeekBarPressure_trace_height, 20);
